...
import { Zap, Sparkles, Bell, ArrowLeft, FlipHorizontal, X, XSquareIcon } from "lucide-react";
            ...
            <div className="max-w-4xl w-full">
                ...
                <Card className="p-12 text-center border-primary/20 shadow-xl">
                    ...
                    <div className="flex items-center justify-center gap-2 mb-6">
                        ...
                        <h1 className="text-3xl font-bold text-primary">Post Spark</h1>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <h2 className="text-5xl font-bold mb-6 text-secondary">
                            <span className="text-gradient-hero">Something Exciting</span>{" "}
                            <br />
                    ...
                    <div className="text-center mt-8 text-muted-foreground">
                        ...
                        <div className="flex gap-4 justify-center mt-3">
                            <a href="https://x.com/PostSparkAgency" target="_blank" rel="noopener noreferrer"
                                className="text-primary/80 hover:text-primary/100 p-2 rounded-lg transition-colors">
                                <img src={"/assets/images/x-social-media-black-icon.svg"} className="h-5 w-5 opacity-60 hover:opacity-100" />
                            </a>
                            ...
                            <a href="www.linkedin.com/in/post-spark-957723365" target="_blank" rel="noopener noreferrer"
                                className="text-primary/80 hover:text-primary/100 p-2 rounded-lg transition-colors">
